# gettting-andGetting and Cleaning Data - Course Project
...
Generate 'Tidy Dataset' that consists of the average (mean) of each variable for each subject and each activity. The result is shown in the file tidy_dataset.txt.-cleaning-data-course-project
